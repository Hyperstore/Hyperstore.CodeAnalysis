...
namespace Irony.Ast
{
    ...
    public class AstBuilder
    {
        ...
        public virtual void BuildAst(ParseTreeNode parseNode)
        {
            ...
            // HACK AM
            else if (config.DefaultNodeCreator == null)
                return;
        ...
        {
            ConstructorInfo ctor = nodeType.GetConstructor(Type.EmptyTypes);
            NewExpression newExp = Expression.New(ctor);
            LambdaExpression lambda = Expression.Lambda(typeof(DefaultAstNodeCreator), newExp);
            return (DefaultAstNodeCreator)lambda.Compile();
